    ...
    return (
        <>
            <section className="overflow-hidden bg-white">
                <h1 className="mb-0 pt-25 text-3xl font-extrabold leading-none tracking-tight text-gray-400 md:text-4xl lg:text-5xl text-center">About Page</h1>
                ...
                <div className="-mx-4 flex flex-wrap items-center justify-between">
                    ...
                    <div className="mt-10 lg:mt-0">
                        <span className="mb-4 block text-lg font-semibold text-blue-600">
                        Why Choose Us
                        </span>
                        ...
                        className="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-7 py-3 text-center text-base font-medium text-white hover:bg-primary/90">
                        Get Started
                        </a>
                    </div>
                    </div>
