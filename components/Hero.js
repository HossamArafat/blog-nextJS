        ...
        <div className="bg-white">
            <div className="relative isolate px-6 pt-14 lg:px-8">
                ...
                <div className="text-center">
                    <h1 className="text-5xl font-semibold tracking-tight text-balance sm:text-7xl">Data to enrich your online business</h1>
                    ...
                    <a href="#" className="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Get started</a>
